...
Account.create!(fullname: "Hoang Anh",address: "Ninh Binh", phone: "123456789", email: "user2@gmail.com", password: "1234567",
  password_confirmation: "1234567", account_type: 0)
Category.create!(name: "Device electronic", parent_id: 0)
Category.create!(name: "Electronic accessories", parent_id: 0)
Category.create!(name: "Technology toys", parent_id: 0)
